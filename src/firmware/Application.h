 ...
 *  Author: ik1xp
 *  This file contains the constants and definitions used by the HF103 FIFO
 * application
 *
 */
...
#define CONSUMER_USB_SOCKET                                                    \
  (CY_U3P_UIB_SOCKET_CONS_1) /* USB Socket 1 is consumer */
...
// With these two defines you can use 'true' and 'false' as well as 'CyTrue' and
// 'CyFalse'
#define true CyTrue
