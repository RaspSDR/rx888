 ...
 */
uint16_t CyFxGpifTransition[] = {0x0000, 0xAAAA, 0x5555, 0xFFFF, 0x3333};
...
/* Summary
   ...
   waveform table.
 */
CyU3PGpifWaveData CyFxGpifWavedata[] = {{{0x1E739E01, 0x00000100, 0x80000000},
                                         {0x00000000, 0x00000000, 0x00000000}},
                                        {{0x2E739A04, 0x20010002, 0x80000080},
                                         {0x00000000, 0x00000000, 0x00000000}},
                                        {{0x1E739A03, 0x24000104, 0x80000080},
                                         {0x00000000, 0x00000000, 0x00000000}},
                                        {{0x1E73D406, 0x24000108, 0x80000040},
                                         {0x3E739C07, 0x00000000, 0x80000100}},
                                        {{0x3E739C05, 0x00000000, 0x80000100},
                                         {0x1E739402, 0x20000100, 0x80000040}},
                                        {{0x1E739A09, 0x00000100, 0x80000000},
                                         {0x00000000, 0x00000000, 0x00000000}},
                                        {{0x2E739A04, 0x20010002, 0x80000080},
                                         {0x1E739E01, 0x00000100, 0x80000000}},
                                        {{0x1E739A08, 0x04000100, 0x80000000},
                                         {0x00000000, 0x00000000, 0x00000000}}};

/* Summary
   Table that maps state indices to the descriptor table indices.
 */
uint8_t CyFxGpifWavedataPosition[] = {0, 1, 2, 3, 4, 5, 6, 7, 2, 1};
